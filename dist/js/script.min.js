...
var gallery = function gallery() {
  var imageItems = document.querySelectorAll('.works__link');
  var imageBig = document.querySelectorAll('.works-gallery');
  var closeImage = document.querySelectorAll('.works-gallery__close');
  var imageOpen = false;
  ...
  closeImage.forEach(function (item) {
    item.addEventListener('click', function () {
      galleryClose();
    });
  });
  imageBig.forEach(function (item) {
