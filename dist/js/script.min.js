  ...
  if (forms.length > 0) {
    forms.forEach(function (item) {
      item.addEventListener('submit', function (e) {
        ...
        if (error === 0) {
          //=========FormData=====================================
          var formData = new FormData(item); // formData.append('image', formImage.files[0]);
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        if (gallery) {
          ...
          var imgMin = img.substring(14); // добавляем блок с картинкой и папкой с большими картинками и подставляем то же значение как и 
