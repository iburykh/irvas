...
/* harmony import */ var _modules_maskTelNumber__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/maskTelNumber */ "./src/js/modules/maskTelNumber.js");
...
/* harmony import */ var _modules_popupGallery__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/popupGallery */ "./src/js/modules/popupGallery.js");
...
var modalState = {};
Object(_modules_form__WEBPACK_IMPORTED_MODULE_1__["default"])(modalState);
Object(_modules_maskTelNumber__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
Object(_modules_popupGallery__WEBPACK_IMPORTED_MODULE_6__["default"])();
...
var changeModalState = function changeModalState(state) {
  var windowForm = document.querySelectorAll('.popup-calc__item'),
...
var form = function form(state) {
  ...
  var inputs = document.querySelectorAll('input'); //==============Настройка отправки формы===================
...
/***/ "./src/js/modules/maskTelNumber.js":
/*!*****************************************!*\
  !*** ./src/js/modules/maskTelNumber.js ***!
  \*****************************************/
/*! exports provided: default */
...
var mask = function mask() {
  var setCursorPosition = function setCursorPosition(pos, elem) {
    elem.focus(); // если у данного импута есть метод setSelectionRange(современные браузеры), то начальное и конечное значение выделения строки будут равны количествусимволов (т.е 2 - это +7), соответственно курсор встанет после +7, для старых браузеров применяется метод createTextRange
  ...
  function createMask(event) {
    var matrix = '+7 (___) ___ __ __',
        ...
        val = this.value.replace(/\D/g, ''); // нельзя удалить +7, т.е если длина вводимых значений будет меньше маски, то вернется маска
...
/***/ "./src/js/modules/popupGallery.js":
/*!****************************************!*\
  !*** ./src/js/modules/popupGallery.js ***!
  \****************************************/
/*! exports provided: default */
...
var popupGallery = function popupGallery() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var gallery = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        if (gallery) {
          var webp = item.querySelector('source').getAttribute('srcset');
          var img = item.querySelector('img').getAttribute('src');
          var webpMin = webp.substring(14); //  обрезаются 14 знаков от начала строки (1.webp)

          var imgMin = img.substring(14);
          popupImg.innerHTML = "\n\t\t\t\t\t<picture>\n\t\t\t\t\t\t<source srcset=\"img/our_works/big_img/".concat(webpMin, "\" type=\"image/webp\">\n\t\t\t\t\t\t<img src=\"img/our_works/big_img/").concat(imgMin, "\" alt=\"\u0444\u043E\u0442\u043E \u043E\u0441\u0442\u0435\u043A\u043B\u0435\u043D\u0438\u044F \u0438 \u043E\u0442\u0434\u0435\u043B\u043A\u0438 \u0431\u0430\u043B\u043A\u043E\u043D\u0430\">\n\t\t\t\t\t</picture>\n\t\t\t\t\t");
        }
...
/* harmony default export */ __webpack_exports__["default"] = (popupGallery);
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_0__["Pagination"]]); // import Swiper from 'swiper/bundle'; (подключение со всеми свойствами)

var slider = function slider() {
  var mainSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.glazing-slider', {
    breakpoints: {
      993: {
        watchOverflow: true,
        slidesPerView: 5
  ...
  var secondSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.decoration-slider', {
    breakpoints: {
      577: {
        watchOverflow: true,
        slidesPerView: 4
...
var tabs = function tabs() {
  ...
  var _loop = function _loop(index) {
    var tab = tabs[index];
    var tabs_items = tab.querySelectorAll(".tabs-item");
    var tabs_blocks = tab.querySelectorAll(".tabs-block");
